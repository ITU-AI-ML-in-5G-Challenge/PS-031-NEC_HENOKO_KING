...
def m_slice(path, path2, dir, step, ex):
    ...
    for i in range(Fs - 1):
        ...
        p = '/home/ryuma/Desktop/ITU_ISIE/codes/Datasets_of_noise/' # ファイル出力するときのパス
        if flag == True:
...
original = '/home/ryuma/Desktop/ITU_ISIE/codes/original.mp4' # オリジナル動画のパス,自分で変更してね
received = '/home/ryuma/Desktop/ITU_ISIE/codes/received_1100kbps_025.mp4' # レシーブ動画のパス,変更してね
